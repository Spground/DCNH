...
public interface AttachementDBMapper {
	...
	@Results({
		@Result(property="attachementId",column="attachement_id",javaType=String.class,jdbcType=JdbcType.VARCHAR),
		@Result(property="filePath",column="attachement_filepath",javaType=String.class,jdbcType=JdbcType.VARCHAR)		
	})
